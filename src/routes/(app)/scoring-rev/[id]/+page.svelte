<script lang="ts">
	...
	const handleActionClicked = (action: Action) => {
		const threes = new Set(['LEFT-CORNER', 'RIGHT-CORNER', 'LEFT-WING', 'RIGHT-WING', 'POINT']);
		openModal = true;
		currAction = action;
	};
...
<Modal title="Action" bind:openModal>
	<div slot="content">
		...
		<div class="flex-1 p-2">
			...
			>
				<g id="Layer_1-2" data-name="Layer 1">
					<rect
						class={classNames(currColor, 'transition-colors duration-300')}
